...
c1.SaveAs("plot/spec_app_nu.png")
...
l1.Draw("same")
ROOT.gPad.RedrawAxis()
c1.SaveAs("plot/spec_app_anu.png")
...
l1.AddEntry(h_nue, "(#nu_{e} + #bar{#nu}_{e}) CC", "L")
