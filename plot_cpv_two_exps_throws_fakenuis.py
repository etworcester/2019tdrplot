...
f1text = "root_callum/cpv_throw_ndfd7year_allsyst_th13_"+hiestr+"_stat:fakenuis:start_v3_BAND.root"
f1 = ROOT.TFile(f1text)
band1 = f1.Get("throws_1sigma")
cpv1 = f1.Get("throws_median")


f2text = "root_callum/cpv_throw_ndfd10year_allsyst_th13_"+hiestr+"_stat:fakenuis:start_v3_BAND.root"
...
f3text = "root_callum/mh_throw_ndfd7year_allsyst_th13_"+hiestr+"_stat:fakenuis:start_v3_BAND.root"
f3 = ROOT.TFile(f3text)
band3 = f3.Get("throws_1sigma")
cpv3 = f3.Get("throws_median")


f4text = "root_callum/mh_throw_ndfd10year_allsyst_th13_"+hiestr+"_stat:fakenuis:start_v3_BAND.root"
...
l1.SetFillColor(0)
l1.Draw("same")
outname = "plot/cpv/cpv_two_exps_throws_fakenuis_"+hier+"_2019.png"
c1.SaveAs(outname)
...
l1.SetFillColor(0)
l1.Draw("same")
outname = "plot/mh/mh_two_exps_throws_fakenuis_"+hier+"_2019.png"
c2.SaveAs(outname)
