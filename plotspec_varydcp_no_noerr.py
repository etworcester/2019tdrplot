...
h_dcpneg = specfile.Get("nue_fhc_nh_3piover2").Rebin(2)
...
c1.SaveAs("plot_v3/spec_app_nu_varydcp_no_noerr.eps")
c1.SaveAs("plot_v3/spec_app_nu_varydcp_no_noerr.png")

#Anti-nu
h = specfile.Get("nue_rhc_nh_0pi").Rebin(2)
h_dcppos = specfile.Get("nue_rhc_nh_piover2").Rebin(2)
h_dcpneg = specfile.Get("nue_rhc_nh_3piover2").Rebin(2)
...
l2.Draw("same")
ROOT.gPad.RedrawAxis()
c1.SaveAs("plot_v3/spec_app_anu_varydcp_no_noerr.eps")
c1.SaveAs("plot_v3/spec_app_anu_varydcp_no_noerr.png")
