...
afdonly = f3.Get("cpv_NuWroBias_actual")
idfdonly = f3.Get("dcp_NuWroBias_actual")
...
l1.AddEntry(null,"NuWro Bias Applied as f(#delta_{CP})","")
l1.SetBorderSize(0)
l1.SetFillStyle(0)
...
l1.SetFillColor(0)
l1.Draw("same")
outname = "plot/cpv/cpv_nuwrobias_exact_2019.png"
c1.SaveAs(outname)
...
t1.Draw("same")
l1.Draw("same")
outname = "plot/res/dcpres_nuwrobias_exact_2019.png"
c2.SaveAs(outname)
