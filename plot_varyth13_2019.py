...
t1.AddText("sin^{2}2#theta_{13} unconstrained")
t1.SetFillColor(0)
t1.SetBorderSize(0)
t1.SetTextAlign(12)
t1.Draw("same")
...
l1.AddEntry(cpv2,"sin^{2}2#theta_{13} = 0.095","L")
l1.AddEntry(cpv1,"sin^{2}2#theta_{13} = 0.088","L")
l1.AddEntry(cpv3,"sin^{2}2#theta_{13} = 0.080","L")
