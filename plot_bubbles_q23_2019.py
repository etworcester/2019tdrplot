...
ssth23list = ["0_42", "0_5", "0_58"]
list7yr = []
for pival in pilist:
    for ssth23 in ssth23list:
        f = ROOT.TFile("root_v4/bubbles/deltapi-ssth23_ndfd_7year_deltapi_"+pival+"__ssth23_"+ssth23+"_th13_hist.root")
...
for pival in pilist:
    for ssth23 in ssth23list:
        f = ROOT.TFile("root_v4/bubbles/deltapi-ssth23_ndfd_10year_deltapi_"+pival+"__ssth23_"+ssth23+"_th13_hist.root")
        h = f.Get("deltapi_ssth23")
        hc = h.Clone()
        hc.SetDirectory(0)
        list10yr.append(hc)
...
for pival in pilist:
    for ssth23 in ssth23list:
        f = ROOT.TFile("root_v4/bubbles/deltapi-ssth23_ndfd_15year_deltapi_"+pival+"__ssth23_"+ssth23+"_th13_hist.root")
        h = f.Get("deltapi_ssth23")
        hc = h.Clone()
        hc.SetDirectory(0)
        list15yr.append(hc)
...
outname = "plot_v4/bubbles/bubbles_q23_2019_v4.eps"
outname2 = "plot_v4/bubbles/bubbles_q23_2019_v4.png"
c1.SaveAs(outname)
c1.SaveAs(outname2)
