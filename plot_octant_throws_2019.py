...
g_dum = graph_15yr.Clone()
g_dum.SetLineColor(ROOT.kBlack)
band_dum = graph_15yr.Clone()
...
leg1.AddEntry(graph_10yr,"10 years (staged)","F")
leg1.AddEntry(graph_15yr,"15 years (staged)","F")
leg1.AddEntry(g_dum,"Median of Throws","L")
leg1.AddEntry(band_dum, "1#sigma: Variations of","F")
