...
#upper 3 sigma bound
f2 = ROOT.TFile("root_v4/oa_variations_10year/cpv_sens_ndfd10year_allsyst_th13_asimov9_hie1_v4.root")
cpv2 = f2.Get("sens_cpv_nh")
f2m = ROOT.TFile("root_v4/oa_variations_10year/mh_sens_ndfd10year_allsyst_th13_asimov9_hie1_v4.root")
mh2 = f2m.Get("sens_mh_nh")

#lower 3 sigma bound
f3 = ROOT.TFile("root_v4/oa_variations_10year/cpv_sens_ndfd10year_allsyst_th13_asimov8_hie1_v4.root")
cpv3 = f3.Get("sens_cpv_nh")
f3m = ROOT.TFile("root_v4/oa_variations_10year/mh_sens_ndfd10year_allsyst_th13_asimov8_hie1_v4.root")
...
l1.SetFillColor(0)
l1.Draw("same")
outname = "plot_v4/vary_params/cpv_varydmsq_2019_v4.eps"
outname2 = "plot_v4/vary_params/cpv_varydmsq_2019_v4.png"
c1.SaveAs(outname)
c1.SaveAs(outname2)
