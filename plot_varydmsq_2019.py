...
#upper 3 sigma bound
f2 = ROOT.TFile("root_callum/cpv_sens_ndfd10year_allsyst_th13_asimov9_hie1_v3.root")
cpv2 = f2.Get("sens_cpv_nh")
f2m = ROOT.TFile("root_callum/mh_sens_ndfd10year_allsyst_th13_asimov9_hie1_v3.root")
mh2 = f2m.Get("sens_mh_nh")

#lower 3 sigma bound
f3 = ROOT.TFile("root_callum/cpv_sens_ndfd10year_allsyst_th13_asimov8_hie1_v3.root")
cpv3 = f3.Get("sens_cpv_nh")
f3m = ROOT.TFile("root_callum/mh_sens_ndfd10year_allsyst_th13_asimov8_hie1_v3.root")
mh3 = f3m.Get("sens_mh_nh")


graph_cpvrange = filldiff(cpv1,cpv2,cpv3)
graph_mhrange = filldiff(mh1,mh2,mh3)
...
l1.AddEntry(cpv2,"#Deltam^{2}_{32} = 2.55 x 10^{-3}","L")
l1.AddEntry(cpv1,"#Deltam^{2}_{32} = 2.45 x 10^{-3}","L")
l1.AddEntry(cpv3,"#Deltam^{2}_{32} = 2.35 x 10^{-3}","L")
...
l1.SetFillColor(0)
l1.Draw("same")
outname = "plot/vary_params/cpv_varydmsq_2019.eps"
outname2 = "plot/vary_params/cpv_varydmsq_2019.png"
c1.SaveAs(outname)
c1.SaveAs(outname2)
...
l1.Draw("same")
outname = "plot/vary_params/mh_varydmsq_2019.eps"
outname2 = "plot/vary_params/mh_varydmsq_2019.png"
c2.SaveAs(outname)
c2.SaveAs(outname2)
