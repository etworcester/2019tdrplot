...
c1.SaveAs("plot_v3/spec_app_nu_no_noerr.eps")
c1.SaveAs("plot_v3/spec_app_nu_no_noerr.png")
...
l1.Draw("same")
ROOT.gPad.RedrawAxis()
c1.SaveAs("plot_v3/spec_app_anu_no_noerr.eps")
c1.SaveAs("plot_v3/spec_app_anu_no_noerr.png")
...
l1.Draw("same")
ROOT.gPad.RedrawAxis()
c1.SaveAs("plot_v3/spec_dis_nu_no_noerr.eps")
c1.SaveAs("plot_v3/spec_dis_nu_no_noerr.png")
...
l1.Draw("same")
ROOT.gPad.RedrawAxis()
c1.SaveAs("plot_v3/spec_dis_anu_no_noerr.eps")
c1.SaveAs("plot_v3/spec_dis_anu_no_noerr.png")
