...
f1 = ROOT.TFile("root_callum/asimov_deltapi-th13_ndfd7year_allsyst_nopen_asimov0_hie1.root")
rdcpz1 = f1.Get("deltapi_th13")

f2 = ROOT.TFile("root_callum/asimov_deltapi-th13_ndfd10year_allsyst_nopen_asimov0_hie1.root")
rdcpz2 = f2.Get("deltapi_th13")

f3 = ROOT.TFile("root_callum/asimov_deltapi-th13_ndfd15year_allsyst_nopen_asimov0_hie1.root")
...
outname = "plot/bubbles/bubbles_q13_2019_fulldisclosure.eps"
outname2 = "plot/bubbles/bubbles_q13_2019_fulldisclosure.png"
c1.SaveAs(outname)
c1.SaveAs(outname2)
